    ...
    public class RobotsController : Controller
    {
        ...
        public void RsdXml()
        {
            ...
            using (var xml = XmlWriter.Create(Response.Body, new XmlWriterSettings { Indent = true }))
            {
                ...
                xml.WriteElementString("enginename", "SimpleBlog");
                xml.WriteElementString("enginelink", "http://github.com/timheuer/simple-blog/");
        ...
        public async Task Rss(string type)
        {
            ...
            {
                var posts = await _blog.GetPosts(20);
                ...
                foreach (Models.Post post in posts)
                {
                    ...
                    item.AddContributor(new SyndicationPerson(_settings.Value.Owner, "you@example.com"));
        ...
        private async Task<ISyndicationFeedWriter> GetWriter(string type, XmlWriter xmlWriter, DateTime updated)
        {
            ...
            if (type.Equals("rss", StringComparison.OrdinalIgnoreCase))
            {
                ...
                await rss.WriteGenerator("SimpleBlog");
            ...
            await atom.WriteGenerator("SimpleBlog", "https://github.com/timheuer/simple-blog", "1.0");
